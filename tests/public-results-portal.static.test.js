...
assert.match(html, /public-results-division-allaround-20260818a/);
...
assert.match(html, /results\.css\?v=public-results-division-allaround-20260818a/, "Results styles must invalidate the browser cache.");
...
assert.match(html, /results\.css\?v=public-results-division-allaround-20260818a/, "Relay styles must invalidate the browser cache.");
