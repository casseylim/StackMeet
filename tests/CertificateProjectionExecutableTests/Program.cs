...
const string actualState = "{\"divisionSettings\":{\"male\":[11,12],\"female\":[11,12],\"combined\":[]},\"settings\":{\"start\":\"2026-07-11\",\"ageCalculationMode\":\"actual\"}}";
const string yearBornState = "{\"divisionSettings\":{\"male\":[11,12],\"female\":[11,12],\"combined\":[]},\"settings\":{\"start\":\"2026-07-11\",\"ageCalculationMode\":\"yearBorn\"}}";
...
Expect("actual age", ParticipantCertificateProjectionService.ResolveDivisionValues(null, new DateOnly(2014, 7, 12), new DateOnly(2026, 7, 11), "M", false, actualState), "11 & Under Male");
Expect("year born", ParticipantCertificateProjectionService.ResolveDivisionValues(null, new DateOnly(2014, 7, 12), new DateOnly(2026, 7, 11), "M", false, yearBornState), "12 Male");
