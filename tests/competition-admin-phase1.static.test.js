...
const authClient = read("backend/StackMeet.Api/wwwroot/js/auth/AuthSession.js");
...
const rootApp = read("backend/StackMeet.Api/wwwroot/app.js");
const hostedApp = read("backend/StackMeet.Api/wwwroot/app.js");
const adminClient = read("backend/StackMeet.Api/wwwroot/admin.js");
const hostedAdminClient = read("backend/StackMeet.Api/wwwroot/admin.js");
const adminPage = read("backend/StackMeet.Api/wwwroot/admin.html");
const hostedAdminPage = read("backend/StackMeet.Api/wwwroot/admin.html");
const rootIndex = read("backend/StackMeet.Api/wwwroot/index.html");
