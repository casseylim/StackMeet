...
namespace StackMeet.Api.Migrations
{
    ...
    [Migration("20260827041853_CertificateTemplatesPhase1A_Hardened")]
    partial class CertificateTemplatesPhase1A_Hardened
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StackMeet.Api.Models.CertificateTemplate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("TemplateSchemaVersion")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompetitionId", "CertificateType")
                        .IsUnique()
                        .HasFilter("[IsActive] = 1");

                    b.HasIndex("CompetitionId", "CertificateType", "TemplateVersion")
                        .IsUnique();

                    b.ToTable("CertificateTemplate", "dbo");
                });
            ...
            modelBuilder.Entity("StackMeet.Api.Models.CertificateTemplate", b =>
                {
                    ...
                    b.HasOne("StackMeet.Api.Models.AppUser", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("StackMeet.Api.Models.AppUser", "UpdatedByUser")
                        .WithMany()
