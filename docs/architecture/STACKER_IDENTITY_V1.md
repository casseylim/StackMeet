...
SP-1 introduced the identity schema. SP-2, SP-3A, SP-3B, SP-4A, SP-4B, SP-4C, SP-4D and SP-4E add no further schema migration.

Integration tests use isolated generated LocalDB databases where required. Characterization phases execute the existing production engines without mutating production data. These development phases do not deploy production code or mutate production data.
